...
using Selu383Bot.Features.OAuth;
using Selu383Bot.Features.Users;
...
public static class GithubLogin
{
    ...
    public static async Task<IActionResult> FinishLogin([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "finish-github-login")] HttpRequest req)
    {
        ...
        var userGithubClient = new RestClient("https://api.github.com", configureSerialization: s=> s.UseSerializer(() => new JsonNetSerializer()));
